...
#args for audio import
    ...
    pathToOriginalsFromProjectRoot = ["Originals","SFX","Foley"] # Where are the English VO files
    ...
    DefaultOriginalsPathForNewFiles = "Cinematics/Foley"  ##TODO Variable this based on import language/SFX
            ...
            if success:
                ...
                for file in MyComponent.ImportAudioFileList:
                    ...
                    if not fname in MyComponent.ExistingWwiseAudio:
                        setupImportArgs(parID, file, MyComponent.DefaultOriginalsPathForNewFiles)
...
###################  Main script flow  ###################
        ...
        pathToOriginalFiles = sourceDir #os.path.join(pathToWwiseProject, *MyComponent.pathToOriginalsFromProjectRoot)
        pathToSectionFiles = os.path.join(pathToOriginalFiles,MyComponent.INPUT_SectionName)
        MyComponent.ImportAudioFilePath = sourceDir #os.path.abspath(pathToSectionFiles)
